...
This error occurs whenever you attempt to compile Flamework with incremental mode enabled. You should delete your `out` directory which will cause TypeScript to completely recompile your project.
